...
import { Person, Receipt, WhatsApp, Timer, Image } from "@mui/icons-material";
          ...
          <Table stickyHeader>
            <TableHead>
              <TableRow>
                ...
                {deposits.length > 0 ? (
                  deposits[0].status === TRANSACTION_STATUS.SUCCESS ? (
                    <TableCell>Approved Time</TableCell>
                  ) : deposits[0].status === TRANSACTION_STATUS.REJECTED ? (
              ...
              {loading ? (
                ...
                deposits.map((deposit, i) => (
                  ...
                  >
                    ...
                    {deposit.status === TRANSACTION_STATUS.SUCCESS ||
                    deposit.status === TRANSACTION_STATUS.REJECTED ? (
                      <TableCell>
                        <Stack spacing={0.5}>
                          <Box
                            sx={{
        ...
        {deposits.length > 0 && (
          ...
          >
            <Typography variant="body2" color="text.secondary">
              ...
              {Math.min(filters.page * filters.limit, totalRecords)} of{" "}
              {totalRecords} deposits
            </Typography>
            <Pagination
              count={totalPages}
              page={filters.page}
